#ifndef bengisuozdemir_ozdemir_bengisu_hw2_AVLclass_H
#define bengisuozdemir_ozdemir_bengisu_hw2_AVLclass_H
#include <iostream>
#include <string>
using namespace std;
...
#include "bengisuozdemir_ozdemir_bengisu_hw2_AVLclass.cpp"
#endif